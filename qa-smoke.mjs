...
const jsFiles=['gamehub.js','expansion.js','advanced-games.js','advanced-pack.js','advanced-worlds.js','stability.js','portal.js'];
const cssFiles=['gamehub.css','expansion.css','advanced-pack.css','advanced-worlds.css','portal.css'];
...
for(const file of cssFiles){if(!styles.includes(file))throw new Error(file+' is not loaded by index.html');}
...
for(const token of ['renderPortal','portal-card','gamehub_favs','gamehub_recent']){if(!portal.includes(token))throw new Error('Portal feature missing: '+token);}
